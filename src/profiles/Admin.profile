...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <classAccesses>
        <apexClass>SO2TP_Constants</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>SO2TP_QuestionProcessor</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>SO2TP_ScheduleTweetGenerator</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>SO2TP_SettingsController</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>SO2TP_StringUtil</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>SO2TP_TestStringUtil</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
    ...
    <custom>false</custom>
    <pageAccesses>
        <apexPage>SO2TP_Settings</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <tabVisibilities>
        <tab>SO2TP_Settings</tab>
